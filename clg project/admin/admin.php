...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/customer1.png">&nbsp&nbsp&nbsp Customers</li>
            <li class="pagebtn"><img src="../image/icon/report1.png">&nbsp&nbsp&nbsp Reports</li>
        </ul>
    </nav>
    ...
    <div class="mainscreen">
        ...
        <iframe class="frames frame4" src="./customer.php" frameborder="0"></iframe>
        <iframe class="frames frame4" src="./report.php" frameborder="0"></iframe>
    </div>
</body>
